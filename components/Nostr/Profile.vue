  ...
  <div class="mx-auto p-4 mt-8 relative">
    ...
    <div v-else-if="eventData" class="p-6 relative z-10 text-center">
      ...
      <div class="text-center">
        <h2
          class="text-4xl font-semibold tracking-tight text-gray-900 dark:text-white sm:text-8xl uppercase"
        >
    ...
    <div
      v-if="eventData && eventData.banner"
...
const { queryEvent } = useNostrCache();
...
onMounted(async () => {
  try {
    ...
    eventData.value = fallbackProfile;
  } finally {
...
const eventData = ref(fallbackProfile);
