<template>
  ...
  <div
    style="z-index: 99"
    class="h-full w-full fixed bg-colorBgLight dark:bg-colorBgDark overflow-scroll isolate px-6 pt-14 lg:px-8 bg-[url('/stock/nogood/NG_Cypher_Header_Light.png')] dark:bg-[url('/stock/nogood/NG_Cypher_Header_Dark.png')] bg-hero bg-no-repeat md:bg-cover bg-center lg:bg-fixed"
  >
    <img
    ...
    <h2
      class="text-4xl font-semibold leading-7 text-gray-900 dark:text-white text-center py-12"
    >
